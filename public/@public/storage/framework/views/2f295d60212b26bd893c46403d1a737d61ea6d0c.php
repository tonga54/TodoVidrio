...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    <div class="form-group col-md-12">
      <a href="<?php echo e(route('productos.create')); ?>" class="btn btn-default float-right">Nuevo producto</a>
    </div>
  </div>
...
<script>
  ...
  var products = {
    get: () => {
      let response = fetch("<?php echo e(route('productos.getAll')); ?>", {
        method: "GET",
        headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/TodoVidrio/resources/views/admin/productos/index.blade.php ENDPATH**/ ?>